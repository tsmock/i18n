...
/* JOSM trac newticket page */ tr("You are about to create a new JOSM ticket.");
/* JOSM trac newticket page */ tr("Please make sure to always use directly in JOSM <a href=\"wiki/Help/Action/ReportBug\">Help/Report bug</a> or the button in <a href=\"wiki/Help/Action/About\">About Dialog</a> (Shift-F1) to come here:");
/* JOSM trac newticket page */ tr("Using this prefills the bug report with useful information for us (<a href=\"wiki/Help/Action/ShowStatusReport\">Status Report</a>). <b>Please do not create defect tickets without status report!");
/* JOSM trac newticket page */ tr("In any case, don’t be shy :) Please let us contact you if needed (either by <a href=\"register\">creating an account</a> or entering your e-mail address below which is normally not visible, but can be extracted in specific situations), and you will be notified about ticket progress.");
